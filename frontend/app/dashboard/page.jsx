...
import { logout, verifyToken } from "../Util/auth";
...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 transition-all duration-200">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static inset-y-0 left-0 z-30 w-72 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
      ...
      >
        <div className="flex items-center justify-between p-6">
          ...
          <button
            onClick={() => setSidebarOpen(false)}
            className="md:hidden p-2 rounded-lg hover:bg-gray-100 dark:text-white"
          >
        ...
        <nav className="px-4 py-2">
          <div className="space-y-1">
            <button
              ...
              className={`w-full flex items-center px-4 py-3 rounded-lg font-medium transition-colors duration-150 ${currentPage === "dashboard"
            ...
            <button
              ...
              className={`w-full flex items-center px-4 py-3 rounded-lg font-medium transition-colors duration-150 ${currentPage === "agents"
                ? "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200"
                : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center px-4 py-3 rounded-lg font-medium transition-colors duration-150 ${currentPage === "upload"
                ? "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200"
                : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center px-4 py-3 rounded-lg font-medium transition-colors duration-150 ${currentPage === "distributed"
                ? "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200"
                : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                }`}
            >
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center">
              <button
                ...
                className="mr-4 p-2 rounded-lg hover:bg-gray-100 dark:text-white md:hidden"
              >
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
                </svg>
